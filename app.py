...
def export_orders():
    ...
    try:
        ...
        for o in res.data:
            writer.writerow([o.get('order_id'), o.get('created_at'), o.get('username'), o.get('phone'), o.get('location'), o.get('item_name'), o.get('total_price'), o.get('amount_paid'), o.get('balance'), o.get('status')])
